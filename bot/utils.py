...
def replace_everywhere(content, search, replace=None):
    ...
    if isinstance(content, Embed):
        if content.title and content.title is not None:
            content.title = content.title.replace(search, replace)
        if content.description and content.description is not None:
            content.description = content.description.replace(search, replace)
        if content.footer and content.footer.text and content.footer.text is not None:
